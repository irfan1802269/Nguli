...
class CategoryDataAdapter (val listMyDatas: ArrayList<CategoryData>, val context: Context) :
    RecyclerView.Adapter<CategoryDataAdapter.GridViewHolder>() {
    ...
    override fun onBindViewHolder(holder: GridViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val moveWithObjectIntent = Intent(context, ContentCategoryActivity::class.java)
            moveWithObjectIntent.putExtra(ContentCategoryActivity.EXTRA_MYDATA, myData)
